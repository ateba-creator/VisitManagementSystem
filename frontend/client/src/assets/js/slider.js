  ...
  (m = {
    ...
    (e.prototype.initialize = function () {
      ...
      this.$element.addClass("owl-loading"),
        (this.$stage = a(
          "<" + this.settings.stageElement + ' className="owl-stage"/>'
...
$add.SliderObj = function (settings) {
  ...
  this.renderer = function () {
    var self = this;
    var $slider = $(
      "<div className='addui-slider addui-slider-" +
    ...
    var $input = $(
      "<input className='addui-slider-input' type='hidden' name='" +
        this._settings.name +
        "' value='" +
        this._settings.value +
        "' />"
    ).appendTo($slider);
    var $track = $("<div className='addui-slider-track'></div>").appendTo(
      $slider
    );
    var $range = $("<div className='addui-slider-range'></div>").appendTo(
      $track
    );

    if (!this._settings.range) {
      var $handle = $(
        "<div className='addui-slider-handle'><div className='addui-slider-value'><span style='font-size: " +
      ...
      var $handle1 = $(
        "<div className='addui-slider-handle addui-slider-handle-l'><div className='addui-slider-value'><span style='font-size: " +
          this._settings.fontsize +
          "px'></span></div></div>"
      ).appendTo($track);
      ...
      var $handle2 = $(
        "<div className='addui-slider-handle addui-slider-handle-h'><div className='addui-slider-value'><span style='font-size: " +
          this._settings.fontsize +
          "px'></span></div></div>"
      ).appendTo($track);
...
!(function (t, e) {
  ...
  function r(t) {
    ...
    return (
      e.touches && e.touches.length && e.touches[0] && (e = e.touches[0]), e
    );
  }
  var u,
    l = (function () {
      function t(e, s, a) {
        n(this, t),
          ...
          (this.uid = s),
          (this.parent = a),
          (this.options = i.default.extend(!0, {}, this.parent.options)),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              this.$element.trigger(
                this.parent.namespace + "::moveStart",
                this
              ),
                (this.data = {}),
                (this.data.start = t[e]),
                (this.data.position = t[e] - n[s]);
              var a = this.parent.getValueFromPosition(this.data.position);
              return (
                this.set(a),
                i.default.each(this.parent.pointer, function (t, e) {
                  e.deactive();
                }),
                this.active(),
          ...
          },
          {
            ...
            value: function (t) {
              this.value !== t &&
                (this.parent.step && (t = this.matchStep(t)),
                !0 === this.options.limit
                  ? (t = this.matchLimit(t))
                  : (t <= this.parent.min && (t = this.parent.min),
                    t >= this.parent.max && (t = this.parent.max)),
                (this.value = t),
                this.updatePosition(),
                this.$element.focus(),
          ...
          },
          {
            ...
            value: function () {
              var t = {};
              (t[this.parent.direction.position] = this.getPercent() + "%"),
                this.$element.css(t);
            },
          },
          {
            ...
            value: function () {
              return (
                ((this.value - this.parent.min) / this.parent.interval) * 100
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                t <=
                  (e =
                    1 === this.uid ? this.parent.min : s[this.uid - 2].value) &&
                  (t = e),
                t >=
                  (i =
    ...
    h = {
      ...
      init: function (t) {
        ...
        var a = {
          ...
          u = 100 / (r - 1),
          l = 100 / (o - 1);
        (this.$scale = (0, i.default)("<div></div>").addClass(a.scale)),
          (this.$lines = (0, i.default)("<ul></ul>").addClass(a.lines)),
          (this.$values = (0, i.default)("<ul></ul>").addClass(a.values));
        for (var h = 0; h < r; h++) {
          (0 === h || h === r || h % ((r - 1) / (o - 1)) == 0
            ? (0, i.default)('<li className="' + a.grid + '"></li>')
            : h % e.grid == 0
            ? (0, i.default)('<li className="' + a.inlineGrid + '"></li>')
            : (0, i.default)("<li></li>")
          )
            .css({ left: u * h + "%" })
            .appendTo(this.$lines);
    ...
    p = {
      ...
      init: function (t) {
        var e = this;
        if (
          ((this.$arrow = (0, i.default)("<span></span>").appendTo(t.$wrap)),
          this.$arrow.addClass(t.namespace + "-selected"),
          !1 === t.options.range &&
            t.p1.$element.on(t.namespace + "::move", function (t, i) {
          ...
          var s = function () {
            ...
            i >= 0
              ? (s = t.p1.getPercent())
              : ((i = -i), (s = t.p2.getPercent())),
              e.$arrow.css({ left: s + "%", width: i + "%" });
          };
          t.p1.$element.on(t.namespace + "::move", s),
            t.p2.$element.on(t.namespace + "::move", s);
        }
      },
    },
    c = {
      ...
      init: function (t) {
        ...
        (this.opts = n),
          ...
          i.default.each(t.pointer, function (n, a) {
            var o = (0, i.default)("<span></span>").appendTo(
              t.pointer[n].$element
            );
            o.addClass(e.classes.tip),
              "onMove" === e.opts.active &&
                (o.css({ display: "none" }),
                a.$element
                  .on(t.namespace + "::moveEnd", function () {
                    return e.hide(o), !1;
                  })
              ...
              a.$element.on(t.namespace + "::move", function () {
                var e = void 0;
                if (
                  ((e = t.options.range ? t.get()[n] : t.get()),
                  "function" == typeof t.options.format)
                )
                  if (t.options.replaceFirst && "number" != typeof e) {
                    if (
                      ("string" == typeof t.options.replaceFirst &&
                        (e = t.options.replaceFirst),
                      "object" === s(t.options.replaceFirst))
                    )
                      for (var i in t.options.replaceFirst)
                        Object.hasOwnProperty(t.options.replaceFirst, i) &&
                          (e = t.options.replaceFirst[i]);
    ...
    f = (function () {
      function t(e, s) {
        ...
        if (
          ...
          "string" == typeof u && (r.value = u.split(",")),
            i.default.each(["min", "max", "step"], function (t, e) {
              var i = parseFloat(a.$element.attr(e));
              isNaN(i) || (r[e] = i);
            }),
            this.$element.css({ display: "none" }),
            (this.$wrap = (0, i.default)("<div></div>")),
            this.$element.after(this.$wrap);
        } else this.$wrap = this.$element;
        if (
          ((this.options = i.default.extend({}, o, s, this.$element.data(), r)),
          (this.namespace = this.options.namespace),
          (this.components = i.default.extend(!0, {}, d)),
          this.options.range && (this.options.replaceFirst = !1),
          (this.value = this.options.value),
          null === this.value && (this.value = this.options.min),
          this.options.range
            ? i.default.isArray(this.value)
              ? 1 === this.value.length && (this.value[1] = this.value[0])
              : (this.value = [this.value, this.value])
            : i.default.isArray(this.value) && (this.value = this.value[0]),
          ...
          "v" === this.options.direction
            ...
            : (this.direction = { axis: "pageX", position: "left" }),
          ...
          [
            {
              ...
              value: function () {
                this.$wrap.append(
                  '<div className="' + this.namespace + '-bar" />'
                ),
                  this.buildPointers(),
                  this.components.selected.init(this),
                  !1 !== this.options.tip && this.components.tip.init(this),
                  !1 !== this.options.scale && this.components.scale.init(this),
                  this.set(this.value),
                  this.bindEvents(),
                  this._trigger("ready"),
                  (this.initialized = !0);
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.p1 = this.pointer[0]),
                  this.options.range && (this.p2 = this.pointer[1]);
              },
            },
            {
              key: "bindEvents",
              value: function () {
                ...
                this.$wrap.on(
                  ...
                  function (t) {
                    if (!0 !== e.disabled) {
                      if ((t = r(t)).which ? 3 === t.which : 2 === t.button)
                        return !1;
                      var i = e.$wrap.offset(),
            ...
            },
            {
              ...
              value: function (t) {
                return t > 0
                  ? this.min + (t / this.getLength()) * this.interval
                  : 0;
              },
            },
            {
            ...
            },
            {
              key: "getLength",
              value: function () {
                return "v" === this.options.direction
                  ? this.$wrap.height()
                  : this.$wrap.width();
              },
            },
            {
              ...
              value: function (t) {
                ...
                (this.updating = !0),
                  ...
                  (t.max || t.min) && this.setInterval(t.min, t.max),
                  t.value || (this.value = t.min),
                  i.default.each(this.components, function (t, i) {
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  return t;
                if (
                  t[0] === this.options.min &&
                  ("string" == typeof this.options.replaceFirst &&
                    (t[0] = this.options.replaceFirst),
                  "object" === s(this.options.replaceFirst))
                )
                  for (var e in this.options.replaceFirst)
                    Object.hasOwnProperty(this.options.replaceFirst, e) &&
                      (t[0] = e);
                return t[0];
              },
            },
            {
              ...
              value: function (t) {
                if (this.options.range) {
                  if (
                    ("number" == typeof t && (t = [t]), !i.default.isArray(t))
                  )
                    return;
                  i.default.each(this.pointer, function (e, i) {
                    i.set(t[e]);
  ...
  f.registerComponent("scale", h),
    f.registerComponent("selected", p),
    f.registerComponent("tip", c),
    (u = (0, i.default)(document)).on("asRange::ready", function (t, e) {
      var s = void 0,
        n = {
          keys: {
            UP: 38,
          ...
          press: function (t) {
            ...
            if (e in n.map && "function" == typeof n.map[e])
              return n.map[e](t), !1;
          },
          attach: function (t) {
            var e = void 0,
      ...
      !0 === e.options.keyboard &&
        i.default.each(e.pointer, function (t, i) {
  ...
  function g(t) {
    for (
      var e = arguments.length, s = Array(e > 1 ? e - 1 : 0), n = 1;
      n < e;
      n++
    )
      s[n - 1] = arguments[n];
    if ("string" == typeof t) {
      ...
      if (!(/^(get)$/.test(a) || ("val" === a && 0 === s.length)))
        return this.each(function () {
    ...
    return this.each(function () {
      (0, i.default)(this).data(v) ||
        (0, i.default)(this).data(v, new f(this, t));
    });
  }
  (i.default.fn.asRange = g),
    (i.default.asRange = i.default.extend(
      {
