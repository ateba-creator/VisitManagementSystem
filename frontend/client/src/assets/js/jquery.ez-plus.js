...
(function ($, window, document, undefined) {
  var EZP = {
    ...
    startZoom: function () {
      ...
      self.zoomContainer = $(
        '<div className="zoomContainer" style="' +
          "position:absolute;" +
          "left:" +
          self.nzOffset.left +
          "px;" +
      ...
      // self.zoomCaption = $('<div className="ezplus-caption" '+
...
$(
  "#zoom_01, #zoom_02 ,#zoom_03 ,#zoom_04 ,#zoom_05 ,#zoom_06 ,#zoom_07 ,#zoom_08 ,#zoom_09 ,#zoom_10"
).ezPlus();
